...
from app.services.admission_mapping.admission_file_mapping import build_exports, map_students, read_file
from app.services.admission_mapping.admission_mapping_pipeline import map_students as pipeline_map_students
...
class AdmissionModuleTests(unittest.TestCase):
    ...
    def test_cli_and_reader_preserve_identifiers(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            for mode, entry in (("script", ["app/scripts/admission_mapping/admission_file_mapping.py"]),
                                ("module", ["-m", "app.scripts.admission_mapping.admission_file_mapping"])):
