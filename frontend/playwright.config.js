...
export default defineConfig({
  ...
  webServer: [
    { command: '..\\.venv\\Scripts\\python.exe -B ..\\Backend\\tests\\browser_fixture_server.py', url: 'http://127.0.0.1:8123/api/v1/mapping/health', timeout: 30000, reuseExistingServer: false, env: { CORS_ORIGINS: 'http://127.0.0.1:5174', SESSION_COOKIE_SECURE: 'false' } },
