...
import { PassResultsBadge } from './PassResultsBadge';
...
export function ResultPreview({ stage, label = 'Choose result group' }) {
  ...
  const filename = names.includes(savedFilename) ? savedFilename : names[0];
